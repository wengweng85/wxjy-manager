...
.btn{ 
  width:241px; border:1px #3F7DAE solid; height:35px; line-height: 30px;
}
.btn2{ 
  width:120px; border:1px #3F7DAE solid; height:30px; line-height: 30px;
}
.login a {
	position: absolute;
    left: 45%;
	...
	<tr>
 	...
 	<tr>
		<td colspan="2" align="center">
			<table>
				<tr>
					<td><button style="width:310px;" class="btn  btn-info btn-xs" onclick="login()">登录</button></td>
				</tr>
			</table>
		</td>
	</tr>
