	        ...
	        <div class="ibox ">
	            ...
	            <div class="ibox-content">
		            <div class="form-horizontal"  >
			           ...
			           <div class="form-group">
			               <rc:select property="code_group" value="${codetype.code_group}"  cols="2,4" dynamic="true" codetype="CODETYPESORT"  label="代码类型分类" required="true" validate="{required:true,messages:{required:'代码类型分类不能为空'}}"/>
			               <rc:textedit  property="code_root_value"  datamask="999999"  cols="2,4" required="true"  value="${codetype.code_root_value}"  label="代码头结点编号"  validate="{required:true,messages:{required:'代码头结点编号不能为空'}}"/>
			           </div>
			           <div class="hr-line-dashed"></div>
			           <div class="form-group">
			               <rc:checkboxswitch label="是否有效"  cols="2,4"  property="aae100"/>
			           </div>
			       </div>
		       </div>
	        </div>
