...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
			    <table id="paramtable" data-url="<c:url value='/sys/param/getList'/>" 
    ...
    var demo_options={
    	formid:'query_form',
    	editable_url:contextPath+'/sys/param/updateparam'
    }
    //初始化
    $(function(){
    	$('.collapse-link').click();
    ...
    function removeRow(value){
    	layer.confirm('确定要删除此参数吗？', function(index){
   			var url= "<c:url value='/sys/param/deleteparambyid/'/>"+value;
