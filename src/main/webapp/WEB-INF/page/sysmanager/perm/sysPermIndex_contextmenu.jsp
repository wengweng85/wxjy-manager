			...
			<div class="ibox ">
				<div class="ibox-title">
					...
					<div class="ibox-tools">
                        ...
                        <a onclick="sys_perm_bat_delete()" class="btn btn-danger btn-xs"><i class="fa fa-remove"></i>批量删除</a>
                    </div>
				</div>
			...
			<div class="ibox ">
				...
				<form action="<c:url value='/sys/perm/saveorupdate'/>"  class="form-horizontal" method="post" id="myform">
                       ...
                       <div class="form-group">
                            <rc:textedit property="parentid"  readonly="true" cols="2,8" label="上级权限编码 " />
                       </div>
                       ...
                       <div class="hr-line-dashed"></div>
                       <div class="form-group">
                            <rc:textedit property="sortnum"  required="true"  type="number" cols="2,8" datamask="99" label="排序号" validate="{required:true,messages:{required:'排序号不能为空'}}"/>
                       </div>
                       <div class="hr-line-dashed"></div>
                       <div class="form-group">
                            <rc:checkboxswitch label="是否有效" property="enabled"  value="1" cols="2,8" />
                       </div>
                       <div class="hr-line-dashed"></div>
                        <div class="form-group">
                           <rc:checkboxswitch label="是否空白窗口打开" property="isblanktarget"  cols="2,8" />
                       </div>
                       <div class="hr-line-dashed"></div>
                       <div class="form-group">
...
function sys_perm_bat_delete(){
    ...
    if(nodes.length>0){
	   	 ...
	   	 layer.confirm('确定删除先中的'+nodes.length+'条权限,此功能原则上只有开发人员才可以操作,删除后系统相关业务程序代码需要同步更新', function(index){
  			var url= "<c:url value='/sys/perm/batdeletePermData/'/>";
