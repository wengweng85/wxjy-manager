...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="col-sm-6">
	        ...
	        <div class="ibox float-e-margins">
	            ...
	            <!-- toolbar -->
	            <div class="ibox-content">
				    <table id="logtable" data-url="<c:url value='/sys/log/getLogList'/>" 
				    ...
				    <thead>
					    <tr>
		                    ...
		                    <th data-field="cost" data-formatter="cost_Formatter">花费时间(毫秒)</th>
		                    <th data-field="userid">用户编号</th>
		                    <th data-field="usergent">代理信息</th>
		                    <th data-field="method">方法类型</th>
					    </tr>
				    </thead>
				    </table>
	            </div>
    ...
    function view_by_id(id){
    	layer.open({
      		  ...
      		  maxmin:true,
      		  area: ['70%', '90%'],
      		  content: "<c:url value='/sys/log/getLogById'/>/"+id //iframe的url
   		});
    }
    </script>
</body>
