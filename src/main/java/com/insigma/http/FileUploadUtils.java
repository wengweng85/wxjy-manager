...
public class FileUploadUtils {
    ...
    public SysFileRecord uploadFile(HttpServletRequest request,String userid, String file_bus_id, String file_bus_type, String url) throws Exception {
        ...
        if (multipartResolver.isMultipart(request)) {
            ...
            while (iter.hasNext()) {
                ...
                return (SysFileRecord) JSONObject.toBean(result.getJSONObject("obj"), SysFileRecord.class);
            }
        }
        return null;
    }
